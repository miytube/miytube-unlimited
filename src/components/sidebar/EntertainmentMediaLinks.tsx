  ...
  const entertainmentMediaLinks = [
    ...
    { 
      ...
      subItems: [
        ...
        { id: 'film-action-crime', label: 'Action, Crime, Thriller', path: '/film/action-crime-thriller' },
        { id: 'film-adventure', label: 'Adventure, Fantasy, Thriller', path: '/film/adventure-fantasy' },
        { id: 'film-comedy-drama', label: 'Comedy, Drama, Crime', path: '/film/comedy-drama-crime' },
        { id: 'film-comedy', label: 'Comedy', path: '/film/comedy' },
        { id: 'film-crime-drama', label: 'Crime, Drama, Thriller', path: '/film/crime-drama-thriller' },
        { id: 'film-documentary', label: 'Documentary', path: '/film/documentary-drama-crime' },
        { id: 'film-drama', label: 'Drama', path: '/film/drama' },
        { id: 'film-gangsters', label: 'Gangsters, Crime, Drama', path: '/film/gangsters-crime-drama' },
        { id: 'film-mystery', label: 'Mystery & Fiction', path: '/film/mystery-fiction' },
        { id: 'film-scientific', label: 'Scientific', path: '/film/scientific' },
       { id: 'film-war', label: 'War Films', path: '/film/war-action-thriller' },
       { id: 'film-movie-trailers', label: 'Film & Movie Trailers', path: '/film/movie-trailers' },
       { id: 'film-movies', label: 'Film & Movies', path: '/film/movies' },
