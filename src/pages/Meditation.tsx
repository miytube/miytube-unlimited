...
const Meditation = () => {
  ...
  const meditationSamples = audioSamples.slice(0, 6);
      ...
      <div className="py-6 animate-fade-in w-full max-w-[1400px] mx-auto px-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <Link to="/meditation/mindfulness" className="block">
            ...
            <Link to="/meditation/sleep" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <Moon size={32} className="mx-auto mb-2 text-primary" />
            ...
            <Link to="/meditation/stress-relief" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <Moon size={32} className="mx-auto mb-2 text-primary" />
            ...
            <Link to="/meditation/morning" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <Moon size={32} className="mx-auto mb-2 text-primary" />
            ...
            <Link to="/meditation/anxiety" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <Moon size={32} className="mx-auto mb-2 text-primary" />
            ...
            <Link to="/meditation/focus" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <Moon size={32} className="mx-auto mb-2 text-primary" />
