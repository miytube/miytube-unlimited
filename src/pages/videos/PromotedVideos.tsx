...
const PromotedVideos = () => {
  ...
  // Promoted videos - filter by promoted tag or category
  const promotedVideos = [...uploadedVideos]
    .filter(video => 
    ...
    <Layout>
      <div className="py-6 animate-fade-in w-full max-w-[1400px] mx-auto px-2 sm:px-4">
        <p className="text-sm text-muted-foreground mb-2">
          <span className="font-semibold text-primary">MiyTube</span> / Video Library / Promoted
        </p>
        
        <div className="flex items-center gap-3 mb-8">
          <Megaphone className="h-8 w-8 text-primary" />
          <h1 className="text-3xl font-bold">Promoted Videos</h1>
          <p className="text-muted-foreground ml-2">Promoted video content</p>
        ...
        {promotedVideos.length > 0 ? (
          ...
          <div className="p-6 bg-muted/20 rounded-lg text-center">
            <p className="text-muted-foreground mb-4">No promoted videos yet. Tag videos as "promoted" to see them here.</p>
