...
const PersonalVideos = () => {
  ...
  // Personal videos - filter by personal tag or category
  const personalVideos = [...uploadedVideos]
    .filter(video => 
    ...
    <Layout>
      <div className="py-6 animate-fade-in w-full max-w-[1400px] mx-auto px-2 sm:px-4">
        <p className="text-sm text-muted-foreground mb-2">
          <span className="font-semibold text-primary">MiyTube</span> / Video Library / Personal
        </p>
        
        <div className="flex items-center gap-3 mb-8">
          <User className="h-8 w-8 text-primary" />
          <h1 className="text-3xl font-bold">Personal Videos</h1>
          <p className="text-muted-foreground ml-2">Your personal video collection</p>
        ...
        {personalVideos.length > 0 ? (
          ...
          <div className="p-6 bg-muted/20 rounded-lg text-center">
            <p className="text-muted-foreground mb-4">No personal videos yet. Tag videos as "personal" to see them here.</p>
