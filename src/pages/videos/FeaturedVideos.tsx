...
const FeaturedVideos = () => {
  ...
  // Featured videos - filter by featured tag or category
  const featuredVideos = [...uploadedVideos]
    .filter(video => 
    ...
    <Layout>
      <div className="py-6 animate-fade-in w-full max-w-[1400px] mx-auto px-2 sm:px-4">
        <p className="text-sm text-muted-foreground mb-2">
          <span className="font-semibold text-primary">MiyTube</span> / Video Library / Featured
        </p>
        
        <div className="flex items-center gap-3 mb-8">
          <Star className="h-8 w-8 text-primary" />
          <h1 className="text-3xl font-bold">Featured Videos</h1>
          <p className="text-muted-foreground ml-2">Hand-picked featured content</p>
        ...
        {featuredVideos.length > 0 ? (
          ...
          <div className="p-6 bg-muted/20 rounded-lg text-center">
            <p className="text-muted-foreground mb-4">No featured videos yet. Tag videos as "featured" to see them here.</p>
