...
const MostViewedVideos = () => {
  ...
  // Most viewed videos - sorted by view count
  const mostViewedVideos = [...uploadedVideos]
    ...
    <Layout>
      <div className="py-6 animate-fade-in w-full max-w-[1400px] mx-auto px-2 sm:px-4">
        <p className="text-sm text-muted-foreground mb-2">
          <span className="font-semibold text-primary">MiyTube</span> / Video Library / Most Viewed
        </p>
        
        <div className="flex items-center gap-3 mb-8">
          <Eye className="h-8 w-8 text-primary" />
          <h1 className="text-3xl font-bold">Most Viewed Videos</h1>
          <p className="text-muted-foreground ml-2">Videos with the highest view counts</p>
