...
const Audiobooks = () => {
  ...
  const audiobookSamples = audioSamples.slice(0, 6);
      ...
      <div className="py-6 animate-fade-in w-full max-w-[1400px] mx-auto px-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <Link to="/audiobooks/fiction" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="font-medium">Fiction</div>
                </div>
              </div>
            </Link>
            <Link to="/audiobooks/non-fiction" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <BookOpen size={32} className="mx-auto mb-2 text-primary" />
            ...
            <Link to="/audiobooks/mystery" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <BookOpen size={32} className="mx-auto mb-2 text-primary" />
            ...
            <Link to="/audiobooks/fantasy" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <BookOpen size={32} className="mx-auto mb-2 text-primary" />
            ...
            <Link to="/audiobooks/science" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <BookOpen size={32} className="mx-auto mb-2 text-primary" />
            ...
            <Link to="/audiobooks/biography" className="block">
              <div className="aspect-square rounded-lg overflow-hidden relative group bg-card flex items-center justify-center">
                <div className="text-center">
                  <BookOpen size={32} className="mx-auto mb-2 text-primary" />
