...
const WorldNewsCategory = () => {
  ...
  const videos = filterVideosBySubcategory(uploadedVideos, 'World News', 'news-world');
      ...
      <div className="py-6 animate-fade-in w-full max-w-[1400px] mx-auto px-4">
        ...
        {videos.length > 0 ? (
          ...
          <div className="text-center py-12 bg-card rounded-lg mb-8">
            ...
            <p className="text-muted-foreground mb-4">Be the first to upload international news!</p>
