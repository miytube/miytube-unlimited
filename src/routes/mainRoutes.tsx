...
export const mainRoutes = [
  ...
  <Route key="channel-handle-shorts" path="/@:handle/shorts" element={<Shorts />} />,
  <Route key="channel-handle-videos" path="/@:handle/videos" element={<Channel />} />,
  <Route key="channel-handle-about" path="/@:handle/about" element={<Channel />} />,
  <Route key="channel-handle-playlists" path="/@:handle/playlists" element={<Channel />} />,
  <Route key="channel-handle-community" path="/@:handle/community" element={<Channel />} />,
  ...
  <Route key="travel-cities-legacy" path="/travel-cities" element={<Navigate to="/travel-events/cities-towns" replace />} />,
  <Route key="cities-towns-legacy" path="/cities-towns" element={<Navigate to="/travel-events/cities-towns" replace />} />,
  <Route key="travel-cities-nested-legacy" path="/travel/cities" element={<Navigate to="/travel-events/cities-towns" replace />} />,
