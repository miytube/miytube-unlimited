...
export const subcategoryOptionsByCategory: Record<string, Array<{ id: string; name: string }>> = {
  ...
  'boxing': [
    { id: 'boxing-105-126-weight', name: 'Boxing (105 - 126 weight)' },
    { id: 'boxing-130-154-weight', name: 'Boxing (130 - 154 weight)' },
    { id: 'boxing-160-200-weight', name: 'Boxing (160 - 200 weight)' },
    { id: 'boxing-heavyweight-fighting', name: 'Boxing (heavyweight fighting)' },
    { id: 'boxing-best-pound-for-pound-fighter', name: 'Boxing (best pound for pound fighter)' },
    { id: 'boxing-boxing-knockouts', name: 'Boxing (boxing knockouts)' },
    { id: 'boxing-gossip-lifestyles-reports', name: 'Boxing (gossip, lifestyles, reports)' },
    { id: 'boxing-gossip-rumor-talk', name: 'Boxing (gossip, rumor, talk)' },
    { id: 'boxing-history-news-rumors', name: 'Boxing (history, news, rumors)' },
    { id: 'boxing-news-news-interviews', name: 'Boxing News (news, interviews)' },
    { id: 'amateur', name: 'Amateur Boxing' },
    { id: 'professional', name: 'Professional Boxing' },
    { id: 'street-fighting', name: 'Street Fighting & Brawls' },
    { id: 'training', name: 'Boxing Training' },
  ],
  'nfl': [
