...
const routeValueAliases: Record<string, string[]> = {
  ...
  'travel-events/cities-towns': ['cities-towns', 'cities', 'towns', 'travel-cities', 'travel-events-cities-towns', 'travel-cities-towns', 'cities-and-towns'],
  'travel-events-cities-towns': ['cities-towns', 'cities', 'towns', 'travel-cities', 'travel-cities-towns', 'cities-and-towns'],
  'travel/cities': ['cities-towns', 'cities', 'towns', 'travel-cities', 'travel-events-cities-towns', 'cities-and-towns'],
